...
Clazz.load (["J.adapter.readers.molxyz.IntV3000"], "J.adapter.readers.molxyz.V3000Rdr", ["java.util.Hashtable", "JU.SB", "J.adapter.smarter.AtomSetCollectionReader"], function () {
c$ = Clazz.decorateAsClass (function () {
this.mr = null;
this.line = null;
this.userData = null;
Clazz.instantialize (this, arguments);
}, J.adapter.readers.molxyz, "V3000Rdr", null, J.adapter.readers.molxyz.IntV3000);
Clazz.overrideMethod (c$, "set", 
function (mr) {
this.mr = mr;
return this;
}, "J.adapter.smarter.AtomSetCollectionReader");
Clazz.overrideMethod (c$, "readAtomsAndBonds", 
function (tokens) {
