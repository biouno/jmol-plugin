...
f)return nc(l,b);for(c=l;c=c.parentNode;)k.unshift(c);for(c=b;c=c.parentNode;)h.unshift(c);for(;k[d]===h[d];)d++;return d?nc(k[d],h[d]):k[d]===S?-1:h[d]===S?1:0};return a};y.matches=function(l,a){return y(l,null,null,a)};y.matchesSelector=function(l,a){(l.ownerDocument||l)!==K&&ba(l);a=a.replace(pd,"='$1']");if(z.matchesSelector&&X&&(!pa||!pa.test(a))&&(!O||!O.test(a)))try{var b=Wa.call(l,a);if(b||z.disconnectedMatch||l.document&&11!==l.document.nodeType)return b}catch(c){}return 0<y(a,K,null,[l]).length};
...
Jmol._version||(Jmol=function(a){var m=function(a){return{header:a++,rear:a++,main:a++,image:a++,front:a++,fileOpener:a++,coverImage:a++,dialog:a++,menu:a+9E4,monitorZIndex:a+99999}},m={_version:"JSmol 14.1.14 Apr 27, 2014",_alertNoBinary:!0,_allowedJmolSize:[25,2048,300],_fileCache:null,_jarFile:null,_j2sPath:null,_use:null,_j2sLoadMonitorOpacity:90,_applets:{},_asynchronous:!0,_ajaxQueue:[],_getZOrders:m,_z:m(Jmol.z||9E3),_debugCode:!0,db:{_databasePrefixes:"$=:",_fileLoadScript:";if (_loadScript = '' && defaultLoadScript == '' && _filetype == 'Pdb') { select protein or nucleic;cartoons Only;color structure; select * };",
...
function(c){return a._drag(b,c)});a._drag=function(b,c){c.stopPropagation();c.preventDefault();if("touchmove"==c.type&&a._gestureUpdate(b,c))return!1;var d=a._jsGetXY(b,c);if(!d)return!1;b.isDragging||(d[2]=0);b.applet._processEvent(b.isDragging?506:503,d);return!1};a.$bind(b,"DOMMouseScroll mousewheel",function(c){c.stopPropagation();c.preventDefault();b.isDragging=!1;var d=c.originalEvent,d=d.detail?d.detail:("mac"==a.featureDetection.os?1:-1)*d.wheelDelta;c=a._jsGetMouseModifiers(c);b.applet._processEvent(-1,
[0>d?-1:1,0,c]);return!1});a.$bind(b,"contextmenu",function(){return!1});a.$bind(b,"mouseout",function(c){b.applet._applet&&b.applet._applet.viewer.startHoverWatcher(!1);a._jsGetXY(b,c);return!1});a.$bind(b,"mouseenter",function(c){b.applet._applet&&b.applet._applet.viewer.startHoverWatcher(!0);if(0===c.buttons||0===c.which){b.isDragging=!1;c=a._jsGetXY(b,c);if(!c)return!1;b.applet._processEvent(504,c);b.applet._processEvent(502,c);return!1}});a.$bind(b,"mousemoveoutjsmol",function(c,b,d){if(a._mouseOwner&&
a._mouseOwner.isDragging)return a._drag(a._mouseOwner,d)});b.applet._is2D&&a.$resize(function(){b.applet&&b.applet._resize()});a.$bind("body","mouseup touchend",function(){b.applet&&(b.isDragging=!1);a._setMouseOwner(null)})};a._jsUnsetMouse=function(c){c.applet=null;a.$bind(c,"mousedown touchstart mousemove touchmove mouseup touchend DOMMouseScroll mousewheel contextmenu mouseout mouseenter",null);a._setMouseOwner(null)};a.Swing={count:0,menuInitialized:0,menuCounter:0,htDialogs:{}};var c=a.Swing;
SwingController=c;c.setDraggable=function(c){c=c.prototype;c.setContainer||(c.setContainer=function(c){this.container=c;c.obj=this;this.ignoreMouse=this.isDragging=!1;var b=this;c.bind("mousedown touchstart",function(c){if(b.ignoreMouse)return b.ignoreMouse=!1,!0;a._setMouseOwner(b,!0);b.isDragging=!0;b.pageX=c.pageX;b.pageY=c.pageY;return!1});c.bind("mousemove touchmove",function(c){if(b.isDragging&&a._mouseOwner==b)return b.mouseMove(c),!1});c.bind("mouseup touchend",function(c){b.mouseUp(c);a._setMouseOwner(null)})},
c.mouseUp=function(c){if(this.isDragging&&a._mouseOwner==this)return this.pageX0+=c.pageX-this.pageX,this.pageY0+=c.pageY-this.pageY,this.isDragging=!1;a._setMouseOwner(null)},c.setPosition=function(){if(null===a._mousePageX){var c=a.$offset(this.applet._id+"_"+(this.applet._is2D?"canvas2d":"canvas"));a._mousePageX=c.left;a._mousePageY=c.top}this.pageX0=a._mousePageX;this.pageY0=a._mousePageY;this.container.css({top:a._mousePageY+"px",left:a._mousePageX+"px"})},c.mouseMove=function(c){this.isDragging&&
a._mouseOwner==this&&this.container.css({top:this.pageY0+(c.pageY-this.pageY)+"px",left:this.pageX0+(c.pageX-this.pageX)+"px"})},c.dragBind=function(c){this.container.unbind("mousemoveoutjsmol");this.container.unbind("touchmoveoutjsmol");this.container.unbind("mouseupoutjsmol");this.container.unbind("touchendoutjsmol");a._setMouseOwner(null);if(c){var b=this;this.container.bind("mousemoveoutjsmol touchmoveoutjsmol",function(a,c,d){b.mouseMove(d)});this.container.bind("mouseupoutjsmol touchendoutjsmol",
function(a,c,d){b.mouseUp(d)})}})};c.JSDialog=function(){};c.setDraggable(c.JSDialog);c.getScreenDimensions=function(a){a.width=m(window).width();a.height=m(window).height()};c.dispose=function(b){a.$remove(b.id+"_mover");delete c.htDialogs[b.id];b.container.obj.dragBind(!1)};c.register=function(a,d){a.id=d+ ++c.count;c.htDialogs[a.id]=a};c.setDialog=function(b){a._setMouseOwner(null);a.$remove(b.id);var d=b.id+"_mover",e=a._$(d),g;e[0]?(e.html(b.html),g=e[0].jd):(a.$after("body","<div id='"+d+"' style='position:absolute;left:0px;top:0px;'>"+
b.html+"</div>"),g=new c.JSDialog,e=a._$(d),b.container=e,g.applet=b.manager.vwr.applet,g.setContainer(e),g.dialog=b,g.setPosition(),g.dragBind(!0),e[0].jd=g);a.$bind("#"+b.id+" .JButton","mousedown touchstart",function(){g.ignoreMouse=!0});a.$bind("#"+b.id+" .JComboBox","mousedown touchstart",function(){g.ignoreMouse=!0});a.$bind("#"+b.id+" .JCheckBox","mousedown touchstart",function(){g.ignoreMouse=!0});a.$bind("#"+b.id+" .JTextField","mousedown touchstart",function(){g.ignoreMouse=!0});a.$bind("#"+
b.id+" .JTable","mousedown touchstart",function(){g.ignoreMouse=!0});a.$bind("#"+b.id+" .JScrollPane","mousedown touchstart",function(){g.ignoreMouse=!0});a.$bind("#"+b.id+" .JEditorPane","mousedown touchstart",function(){g.ignoreMouse=!0})};c.setSelected=function(c){a.$prop(c.id,"checked",!!c.selected)};c.setSelectedIndex=function(c){a.$prop(c.id,"selectedIndex",c.selectedIndex)};c.setText=function(c){a.$prop(c.id,"value",c.text)};c.setVisible=function(c){a.$setVisible(c.id,c.visible)};c.setEnabled=
function(c){a.$setEnabled(c.id,c.enabled)};c.click=function(b,d){var e=c.htDialogs[b.id];if(e){var g=e.toString();if(0<=g.indexOf("JCheck"))e.selected=b.checked;else if(0<=g.indexOf("JCombo"))e.selectedIndex=b.selectedIndex;else if(null!=e.text&&(e.text=b.value,d&&13!=(d.charCode||d.keyCode)))return}g=c.htDialogs[a.$getAncestorDiv(b.id,"JDialog").id];g.manager.actionPerformed(e?e.name:g.registryKey+"/"+b.id)};c.setFront=function(c){var d=c.manager.vwr.applet;c.zIndex!=a._getZ(d,"dialog")&&(c.zIndex=
a._incrZ(d,"dialog"));c.container&&((c.container[0]||c.container).style.zIndex=c.zIndex)};c.hideMenus=function(a){if(a=a._menus)for(var d in a)a[d].visible&&c.hideMenu(a[d])};c.windowClosing=function(b){b=c.htDialogs[a.$getAncestorDiv(b.id,"JDialog").id];b.registryKey?b.manager.processWindowClosing(b.registryKey):b.dispose()};a._track=function(c){if(a._tracker){try{var d='<iframe style="display:none" width="0" height="0" frameborder="0" tabindex="-1" src="'+(a._tracker+"&applet="+c._jmolType+"&version="+
a._version+"&appver="+self.___JmolVersion+"&url="+encodeURIComponent(document.location.href))+'"></iframe>';a.$after("body",d)}catch(e){}delete a._tracker}return c};a.getProfile=function(){window["j2s.doProfile"]=!0;if(self.Clazz&&self.JSON)return Clazz._profile||(Clazz._profile={}),Clazz.getProfile()};a._getInChIKey=function(a,c){0<=c.indexOf("MOL=")&&c.split("MOL=")[1].split('"')};a._getAttr=function(a,c){var d=a.indexOf(c+"=");return 0<=d&&0<=(d=a.indexOf('"',d))?a.substring(d+1,a.indexOf('"',
d+1)):null};a.User={viewUpdatedCallback:null};a.View={count:0,applets:{},sets:{}};(function(c){c.updateView=function(d,e){if(null!=d._viewSet){e.chemID||(d._searchQuery=null);e.data||(e.data="N/A");e.type=d._viewType;if(null==(d._currentView=c.__findView(d._viewSet,e)))d._currentView=c.__createViewSet(d._viewSet,e.chemID,e.viewID||e.chemID);d._currentView[e.type].data=e.data;d._currentView[e.type].smiles=d._getSmiles();a.User.viewUpdatedCallback&&a.User.viewUpdatedCallback(d,"updateView");c.__setView(d._currentView,
d,!1)}};c.updateFromSync=function(d,e){d._updateMsg=e;var g=a._getAttr(e,"sourceID")||a._getAttr(e,"file");if(g){var k=c.__findView(d._viewSet,{viewID:g});if(null==k)return a.updateView(d,e);k!=d._currentView&&c.__setView(k,d,!0);var r=(g=a._getAttr(e,"atoms"))&&0<=e.indexOf("selectionhalos ON")?eval("["+g+"]"):[];setTimeout(function(){d._currentView==k&&c.updateAtomPick(d,r)},10);a.User.viewUpdatedCallback&&a.User.viewUpdatedCallback(d,"updateFromSync")}};c.updateAtomPick=function(c,b){var d=c._currentView;
if(null!=d){for(var k in d)"info"!=k&&d[k].applet!=c&&d[k].applet._updateAtomPick(b);a.User.viewUpdatedCallback&&a.User.viewUpdatedCallback(c,"updateAtomPick")}};c.dumpViews=function(a){var d=c.sets[a];if(d){var e="View set "+a+":\n";a=c.applets[a];for(var k in a)e+="\napplet "+a[k]._id+" currentView="+(a[k]._currentView?a[k]._currentView.info.viewID:null);for(k=d.length;0<=--k;){a=d[k];var e=e+("\n\n<b>view="+k+" viewID="+a.info.viewID+" chemID="+a.info.chemID+"</b>\n"),r,g;for(g in a)"info"!=g&&
(e+="\nview="+k+" type="+g+" applet="+((r=a[g]).applet?r.applet._id:null)+" SMILES="+r.smiles+"\n atomMap="+JSON.stringify(r.atomMap)+"\n data=\n"+r.data+"\n")}return e}};c.__init=function(a){var d=a._viewSet,e=c.applets;e[d]||(e[d]={});e[d][a._viewType]=a};c.__findView=function(a,d){var e=c.sets[a];null==e&&(e=c.sets[a]=[]);for(var k=e.length;0<=--k;){var r=e[k];if(d.viewID){if(r.info.viewID==d.viewID)return r}else{if(null!=d.chemID&&d.chemID==r.info.chemID)return r;for(var g in r)if("info"!=g&&
(null!=d.data&&null!=r[g].data?d.data==r[g].data:d.type==g))return r}}return null};c.__createViewSet=function(d,e,g){c.count++;e={info:{chemID:e,viewID:g||"model_"+c.count}};for(var k in a._applets)g=a._applets[k],g._viewSet==d&&(e[g._viewType]={applet:g,data:null});c.sets[d].push(e);return e};c.__setView=function(a,c,b){for(var d in a)if("info"!=d){var e=a[d],g=e.applet,j=b||null!=g&&"<modified>"==g._molData;if(!(null==g||g==c&&!j)){var q=null==e.data,m=null!=g._currentView;g._currentView=a;if(!m||
!(a[d].data==e.data&&!q&!j))if(g._loadModelFromView(a),q)break}}}})(a.View);a.Cache={fileCache:{}};a.Cache.get=function(c){return a.Cache.fileCache[c]};a.Cache.put=function(c,d){a.Cache.fileCache[c]=d};a.Cache.setDragDrop=function(c){a.$appEvent(c,"appletdiv","dragover",function(a){a=a.originalEvent;a.stopPropagation();a.preventDefault();a.dataTransfer.dropEffect="copy"});a.$appEvent(c,"appletdiv","drop",function(d){d=d.originalEvent;d.stopPropagation();d.preventDefault();var e=d.dataTransfer.files[0];
d=new FileReader;d.onloadend=function(d){if(d.target.readyState==FileReader.DONE){var k="cache://DROP_"+e.name;d=a._toBytes(d.target.result);c._applet.viewer.cacheFileByName("cache://DROP_*",!1);"JSV"==c._viewType||k.endsWith(".jdx")?a.Cache.put(k,d):c._applet.viewer.cachePut(k,d);c._applet.viewer.openFileAsyncSpecial(k,1)}};d.readAsArrayBuffer(e)})}})(Jmol,jQuery);Jmol._debugCode=!1;
...
function(a){q.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n")};System.err.__CLASS_NAME__="java.io.PrintStream";System.err.print=function(a){q.consoleOutput(a,"red")};System.err.println=function(a){q.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};a.setConsoleDiv=function(a){window["j2s.lib"]&&(window["j2s.lib"].console=a)};a.binaryFolders=a._Loader.binaryFolders=[a._Loader.getJ2SLibBase()]}(Clazz))};___JmolDate="$Date: 2014-05-29 17:53:50 -0500 (Thu, 29 May 2014) $";
___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";___JmolVersion="14.1.17_2014.05.29";
